  ...
  <a-spin :spinning="!onload">
    <div class="mainWrap">
      ...
      <div class="mainRightWrap">
        <ChangeProps v-if="edit" :handleChangeProps="handleChangeProps" :editProps="editProps" :pushMsg="pushMsg" :editComponentName="editComponent"></ChangeProps>
      </div>
      <a-modal
        title="页面配置"
        v-model="configModal"
...
export default {
  ...
  methods: {
    ...
    receiveMsg: function ({ data }) {
      const { type } = data
      console.group('Main 公共父组件 收到消息 再通过单向数据流传递下去')
      console.log(data)
      console.groupEnd()
      ...
      switch (type) {
        ...
        case 'changeProps':
          ...
          this.editComponent = data.data.componentName
          break
        case 'handleDelCpt':
          /**
           * 删除了选中组件
    ...
    handleChangeProps: function (cont) {
      ...
      this.pushMsg({
        ...
        data: {
          key: this.editKey,
          props: cont,
          componentName: this.editComponent
        }
      })
    }
  }
